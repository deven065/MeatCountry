...
export default function ChatSupport() {
  ...
  const whatsappNumber = '919833703389' // UPDATE THIS WITH YOUR NUMBER
  ...
  return (
    <div className={`fixed ${bottomClass} right-6 z-50 transition-all duration-300`}>
      <button
        ...
        className="group flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all"
